...
type MKodeRegistrasi struct {
	...
	KodeAwal          string    `gorm:"null" valid:"required~Harap tambahkan kode registrasi" json:"kode_awal"`
	KodeAkhir         string    `gorm:"null" valid:"required~Harap tambahkan kode registrasi" json:"kode_akhir"`
